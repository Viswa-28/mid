...
<h2 class="delete-title text-dark">Delete Product</h2>
<p class ="delete-title text-dark">Are you sure you want to delete the product <strong><?= htmlspecialchars($product['name']) ?></strong>?</p>
